// app.js (module)
import { validarTitulo, criarTarefaObjeto, adicionarTarefa, marcarConcluidaPorId, filtrarPor, limparInput } from '/src/tarefas.js';
...
function render() {
const visiveis = filtrarPor(tarefas, filtroAtual);
lista.innerHTML = '';
visiveis.forEach(t => {
...
tarefas = marcarConcluidaPorId(tarefas, t.id);
render();
});
...
const t = criarTarefaObjeto(titulo);
tarefas = adicionarTarefa(tarefas, t);
limparInput(input);
render();
});
